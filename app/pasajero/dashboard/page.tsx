  ...
  return (
    <div className="min-h-screen bg-[#121212] animate-fade-in">
      <header className="bg-[#1a1a1a] border-b border-[#2a2a2a] px-6 py-6">
        ...
        <p className="text-gray-400 text-sm">Encuentra tu próximo viaje</p>
      </header>
      ...
      <main className="px-6 py-8">
        <div className="grid grid-cols-2 gap-4 mb-8">
          <div className="bg-[#1a1a1a] rounded-xl border border-[#2a2a2a] p-4 animate-scale-in">
            <div className="text-center">
              <p className="text-xs text-gray-400 mb-1">Viajes realizados</p>
        ...
        <div>
          ...
          <div className="space-y-3">
            {mockPassengerHistory.map((history, index) => (
              <div
                key={history.id}
